...
export function CreateModelService({ name, description, startPrice, typeId, imageName1, imageName2, imageName3 }) {
...
export function EditModelService({ name, description, startPrice, typeId, imageName1, imageName2, imageName3 }) {
